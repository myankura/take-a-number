...
const takeNumber = function (bandName) {
    //create a variable to store band number to later be incremented
    let num = bandNumber;
    //increment bandNumber by one each time
    bandNumber++;
    //return the order in which the band will play and their name
    return `${num} ${bandName}`;
}

//This is where all of the bandNames will be entered.
